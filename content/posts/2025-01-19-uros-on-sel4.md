...
We will port the [micro ros demo examples](https://github.com/micro-ROS/micro-ROS-demos/tree/kilted/rclc) into sel4 protected domains and discuss how it has been done, and issues faced along with way.
...
We treat seL4 as closer to bare-metal rather than a full fledged operating system, we use the bare-metal compilers and inject some behaviour at the userspace level.
